...
void
g_cclosure_user_marshal_INT__BOOLEAN (GClosure     *closure,
                                      GValue       *return_value G_GNUC_UNUSED,
                                      guint         n_param_values,
                                      const GValue *param_values,
                                      gpointer      invocation_hint G_GNUC_UNUSED,
                                      gpointer      marshal_data)
{
  typedef gint (*GMarshalFunc_INT__BOOLEAN) (gpointer     data1,
                                             gboolean     arg_1,
                                             gpointer     data2);
  register GMarshalFunc_INT__BOOLEAN callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  gint v_return;
  ...
  callback = (GMarshalFunc_INT__BOOLEAN) (marshal_data ? marshal_data : cc->callback);
...
void
g_cclosure_user_marshal_STRING__BOOLEAN (GClosure     *closure,
                                         GValue       *return_value G_GNUC_UNUSED,
                                         guint         n_param_values,
                                         const GValue *param_values,
                                         gpointer      invocation_hint G_GNUC_UNUSED,
                                         gpointer      marshal_data)
{
  typedef gchar* (*GMarshalFunc_STRING__BOOLEAN) (gpointer     data1,
                                                  gboolean     arg_1,
                                                  gpointer     data2);
  register GMarshalFunc_STRING__BOOLEAN callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  gchar* v_return;
  ...
  callback = (GMarshalFunc_STRING__BOOLEAN) (marshal_data ? marshal_data : cc->callback);
...
void
g_cclosure_user_marshal_STRING__INT (GClosure     *closure,
                                     GValue       *return_value G_GNUC_UNUSED,
                                     guint         n_param_values,
                                     const GValue *param_values,
                                     gpointer      invocation_hint G_GNUC_UNUSED,
