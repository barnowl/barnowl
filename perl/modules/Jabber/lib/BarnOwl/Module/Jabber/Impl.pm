...
package BarnOwl::Module::Jabber::Impl;
...
sub onStart {
    if ( *BarnOwl::queue_message{CODE} ) {
        ...
        register_filters();
        $BarnOwl::Hooks::getBuddyList->add("BarnOwl::Module::Jabber::Impl::onGetBuddyList");
        $BarnOwl::Hooks::getQuickstart->add("BarnOwl::Module::Jabber::Impl::onGetQuickstart");
        $vars{show} = '';
...
$BarnOwl::Hooks::startup->add("BarnOwl::Module::Jabber::Impl::onStart");
...
sub do_login {
    ...
    else
    {
        ...
        $client->SetMessageCallBacks(
            chat      => sub { BarnOwl::Module::Jabber::Impl::process_incoming_chat_message(@_) },
            error     => sub { BarnOwl::Module::Jabber::Impl::process_incoming_error_message(@_) },
            groupchat => sub { BarnOwl::Module::Jabber::Impl::process_incoming_groupchat_message(@_) },
            headline  => sub { BarnOwl::Module::Jabber::Impl::process_incoming_headline_message(@_) },
            normal    => sub { BarnOwl::Module::Jabber::Impl::process_incoming_normal_message(@_) }
        );
        $client->SetPresenceCallBacks(
            available    => sub { BarnOwl::Module::Jabber::Impl::process_presence_available(@_) },
            unavailable  => sub { BarnOwl::Module::Jabber::Impl::process_presence_available(@_) },
            subscribe    => sub { BarnOwl::Module::Jabber::Impl::process_presence_subscribe(@_) },
            subscribed   => sub { BarnOwl::Module::Jabber::Impl::process_presence_subscribed(@_) },
            unsubscribe  => sub { BarnOwl::Module::Jabber::Impl::process_presence_unsubscribe(@_) },
            unsubscribed => sub { BarnOwl::Module::Jabber::Impl::process_presence_unsubscribed(@_) },
            error        => sub { BarnOwl::Module::Jabber::Impl::process_presence_error(@_) });
...
BarnOwl::Completion::register_completer(jwrite => sub { BarnOwl::Module::Jabber::Impl::complete_jwrite(@_) });
BarnOwl::Completion::register_completer(jabberlogout => sub { BarnOwl::Module::Jabber::Impl::complete_jabberlogout(@_) });
