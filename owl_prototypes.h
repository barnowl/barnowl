...
extern void owl_aim_addbuddy(char *screenname);
extern void owl_aim_delbuddy(char *screenname);
...
extern void getfile_start(aim_session_t *sess, aim_conn_t *conn, const char *sn);
extern void getfile_requested(aim_session_t *sess, aim_conn_t *conn, aim_userinfo_t *userinfo, struct aim_incomingim_ch2_args *args);
...
extern void owl_message_set_isloginout(owl_message *m);
